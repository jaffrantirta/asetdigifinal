  ...
  <div class="content-wrapper">
    ...
    <div class="card card-primary">
              ...
              <div class="tree">
                <ul>
                    <li><a class='link' href='#'><br> <img style='width:50px; border-radius:40px' src='<?php echo base_url('upload/no_image/profile.gif') ?>'><br><?php if($parent_1['data']!=null){echo $parent_1['data']->name.' - '.$parent_1['data']->lisensi_name;}else{echo 'ADD';} ?></a>
                        <ul>
                            <li>
