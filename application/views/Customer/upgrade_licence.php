...
<?php } ?>
<p id="current_licence_price"><?php echo $get_lisensies[0]->lisensi_price ?></p>
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Upgrade LISENSI</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <option value="not_select_yet">- choose Licence -</option>
                    <?php
                      foreach($lisensies as $data){?>
          ...
          <script src="<?php echo base_url() ?>assets/build/js/customer/UpgradeLicence.js"></script>
