            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Requested By</b> <a class="float-right"><?php echo $order->user_name ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Total Payment</b> <a class="float-right"><?php echo $order->diff_payment  ?> <?php echo $order->currency  ?></a>
                  </li>
                </ul>
                <?php
                if(!$order->is_open){
